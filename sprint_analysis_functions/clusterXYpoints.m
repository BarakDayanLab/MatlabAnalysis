...
%
%% Code
function [clustersXY] = clusterXYpoints(XY,maxdist,minClusterSize,method,mergeflag)
...
% hold on;
% scatter(XY(:,2),XY(:,1),20,'filled','o','CData',[.8,.8,.8]); % plot the original points in light grey
% for k=1:clusterCount
%     plot(clustersXY{k,1}(:,2),clustersXY{k,1}(:,1),'o','Color',cc(k,:),'MarkerFaceColor',cc(k,:));
% end
% axis equal;
